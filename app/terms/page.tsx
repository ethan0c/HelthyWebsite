        ...
        <div className="container mx-auto px-6 lg:px-20 max-w-4xl">
          <div className="space-y-8 text-white/90">
            ...
            <section className="space-y-4">
              ...
              <p>
                Before filing a claim, you agree to contact us at <a href="mailto:helthyapp@gmail.com" className="text-helthy-lemon hover:underline">helthyapp@gmail.com</a> to attempt to resolve the dispute informally.
              </p>
              <p>
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-2 pl-4">
                ...
                <p><strong>Support:</strong> <a href="mailto:helthyapp@gmail.com" className="text-helthy-lemon hover:underline">helthyapp@gmail.com</a></p>
