          ...
          <div className="space-y-8 text-white/90">
            <div className="space-y-4 pb-8 border-b border-white/10">
              <h1 className="font-heading font-light text-[clamp(2rem,4vw,3.25rem)] leading-[1.05] tracking-[-0.02em] text-white">
                <span className="text-italics">Terms</span> of Service
              </h1>
            ...
            <section className="space-y-4">
              <h2 className="font-body font-bold text-2xl text-white">1. Acceptance of Terms</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="font-body font-bold text-2xl text-white">2. Description of Service</h2>
            ...
            <section className="space-y-4">
              <h2 className="font-body font-bold text-2xl text-white">3. Eligibility</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="font-body font-bold text-2xl text-white">4. Account Registration and Security</h2>
              <div className="space-y-3">
                <h3 className="font-body font-normal text-xl text-white/90">4.1 Account Creation</h3>
                <ul className="list-disc list-inside space-y-2 pl-4">
              ...
              <div className="space-y-3">
                <h3 className="font-body font-normal text-xl text-white/90">4.2 Account Security</h3>
                <ul className="list-disc list-inside space-y-2 pl-4">
            ...
            <section className="space-y-4 bg-red-500/10 border border-red-500/20 rounded-lg p-6">
              <h2 className="font-body font-bold text-2xl text-red-400">5. Medical Disclaimer and Limitation of Liability</h2>
              <div className="space-y-3">
                <h3 className="font-body font-normal text-xl text-red-300">5.1 NOT MEDICAL ADVICE</h3>
              ...
              <div className="space-y-3">
                <h3 className="font-body font-normal text-xl text-red-300">5.2 Health Risks</h3>
              ...
              <div className="space-y-3">
                <h3 className="font-body font-normal text-xl text-red-300">5.3 Limitation of Liability</h3>
            ...
            <section className="space-y-4">
              <h2 className="font-body font-bold text-2xl text-white">6. User Responsibilities and Acceptable Use</h2>
              <div className="space-y-3">
                <h3 className="font-body font-normal text-xl text-white/90">6.1 Acceptable Use</h3>
            ...
            <section className="space-y-4">
              <h2 className="font-body font-bold text-2xl text-white">7. Intellectual Property</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="font-body font-bold text-2xl text-white">8. Account Suspension and Termination</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="font-body font-bold text-2xl text-white">9. Third-Party Services</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="font-body font-bold text-2xl text-white">10. Dispute Resolution</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="font-body font-bold text-2xl text-white">11. Contact Information</h2>
